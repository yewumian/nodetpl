...
define("ace/mode/nodetpl",["require","exports","module","ace/lib/oop","ace/mode/html_highlight_rules","ace/mode/javascript_highlight_rules","ace/lib/oop","ace/mode/html","ace/mode/javascript","ace/mode/css","ace/mode/ruby"], function (require, exports, module) {
  "use strict";
  ...
  var NodetplHighlightRules = function (start, end) {
    ...
    this.embedRules(JavaScriptHighlightRules, "nodetpl-");

    this.$rules["nodetpl-start"].unshift({
      token: "markup.list.meta.tag",
      regex: "-?" + end,
      next: "pop"
    }, {
    ...
    this.$rules["nodetpl-no_regex"].unshift({
      token: "markup.list.meta.tag",
      regex: "-?" + end,
      next: "pop"
    }, {
  ...
  oop.inherits(NodetplHighlightRules, HtmlHighlightRules);

  exports.NodetplHighlightRules = NodetplHighlightRules;
  ...
  var Mode = function () {
    HtmlMode.call(this);
    this.HighlightRules = NodetplHighlightRules;
    this.createModeDelegates({
      "js-": JavaScriptMode,
      "css-": CssMode,
      "nodetpl-": JavaScriptMode
    });
  };
