...
;(function (window, document, undefined ) {
  ...
  window[moduleName].render = function(html, data, callback){
    var path = this.rguid(), that = this, cache = that._tpls;
    var renderTools = {
      trim: function(str){
      ...
      precompile: function(tpl){
        if(!tpl) return false;
        var tplTemp, tplList = {}, compileList = {};
      ...
      compile: function(tplList, compileList){
        ...
        for(var tplname in tplList){
          ...
          var jsTemp, cssTemp, jscode = '', csscode = '';
          ...
          if(jscode){
            ...
            for(var i=0; i<_jscode.length; i++){
              ...
              _jscode[i] = '    template.push(\'' + _jscode[i]
                  ...
                  .replace(/require\(([^\)]*)\)/ig, function(a, b){
                    var _b = (b || '').split(',');
